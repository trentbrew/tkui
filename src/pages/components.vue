          ...
          <ui-sidebar-group-content>
            <ui-sidebar-menu>
              <ui-sidebar-menu-item>
                <ui-sidebar-menu-button
                  as-child
                  :is-active="route.path.startsWith('/components/toolkitui/components')"
                >
              ...
              <ui-sidebar-menu-item>
                <ui-sidebar-menu-button
                  as-child
                  :is-active="route.path.startsWith('/components/toolkitui/templates')"
                >
              ...
              <ui-sidebar-menu-item>
                <ui-sidebar-menu-button
                  as-child
                  :is-active="route.path.startsWith('/components/toolkitui/docs')"
                >
                    ...
                    <ui-sidebar-menu-sub>
                      ...
                      >
                        <ui-sidebar-menu-sub-button
                          as-child
                          :is-active="activeComponent === component.id"
                        >
